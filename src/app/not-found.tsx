  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center text-white text-center px-4 z-2">
      <div className=" max-w-full ">
        <Image
          src="/images/cinemaScreen404.png"
      ...
      <Link href="/" passHref>
        <button className="relative z-20 justify-center mt-36  bg-red-600 hover:bg-red-700 transition-colors text-white px-6 py-2 rounded-full shadow-md">
          Go Home
        </button>
      </Link>
    </div>
